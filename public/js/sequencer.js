...
const SEQ = (() => {
  ...
  function buildChannelSliders(cue) {
    ...
    if (cue.cell) channels = channels.filter(ch => ch.cell === cue.cell || (!ch.cell && ['dimmer','strobe','speed','macro','other','reset','pan','pan_fine','tilt','tilt_fine','gobo','gobo_rotation','color_wheel','focus','zoom','prism','smoke','atmosphere','motor'].includes(ch.type)));
